          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>{{$banner->slug}}</td>
                    <td>
                    <img style="width: 150px; height: 100px;" src="{{$banner -> 	photo}}"> 
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="{{route('banner.destroy',$banner->id)}}" class="btn btn-danger btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Delete" data-placement="bottom"><i class="fas fa-trash-alt"></i></a>
